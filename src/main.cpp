...
uint256 hashGenesisBlock("0x260ddfc5bb1d63923f1292b9750f9a737388ee2b72bbf9a9688a16549789de1c");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // RainbowGoldCoin: starting difficulty is 1 / 2^12
static CBigNum bnInitialDifficulty(~uint256(0) >> 27);
...
const string strMessageMagic = "RainbowGoldCoin Signed Message:\n";
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal RainbowGoldCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "RainbowGoldCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "May your pockets be heavy and your hearts be light. Mine for me gold and find delight!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 88 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040224210fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a804d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1394045344;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 416160;

        if (fTestNet)
        {
            block.nTime    = 123;	//not active
            block.nNonce   = 123;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2f34f69069d25c3c6cdf1a38a3aa3794455a52d5ada7fdb83524a19ba0f37488"));
...
unsigned char pchMessageStart[4] = { 0xfd, 0xa1, 0xb9, 0xd6 }; 
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // RainbowGoldCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
